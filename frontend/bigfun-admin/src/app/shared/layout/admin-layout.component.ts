...
export class AdminLayoutComponent implements OnInit {
  ...
  private allNav: NavItem[] = [
    ...
    { path: '/deposits', label: 'Deposits', icon: '💰', permission: 'deposits.view' },
    { path: '/withdrawals', label: 'Withdrawals', icon: '🏦', permission: 'withdrawals.view' },
    { path: '/battles', label: 'Battles', icon: '⚔️', permission: 'battles.view' },
    { path: '/users', label: 'Users', icon: '👥', permission: 'users.view' },
    { path: '/kyc', label: 'KYC', icon: '🪪', permission: 'kyc.view' },
    { path: '/transactions', label: 'Transactions', icon: '📋', permission: 'transactions.view' },
    { path: '/settings', label: 'Settings', icon: '⚙️', permission: 'settings.view' },
  ];
