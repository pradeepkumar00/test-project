...
const authController = require('../../controllers/superadmin/auth');
...
router.get('/health', (req, res) => {
  res.json({
    success: true,
    message: 'Masti Ludo Superadmin API is running',
...
// All routes below require a valid admin JWT + role === superadmin
...
router.get('/permissions', adminsController.listPermissionCatalog);
router.get('/admins', adminsController.listAdmins);
router.post('/admins', adminsController.createAdminValidation, validate, adminsController.createAdmin);
router.put('/admins/:id', adminsController.updateAdminValidation, validate, adminsController.updateAdmin);
